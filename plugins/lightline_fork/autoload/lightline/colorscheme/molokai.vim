...
let s:p.normal.left = [ [ s:darkgray, s:cyan ], [ s:cyan, s:darkgray ] ]
let s:p.normal.middle = [ [ s:cyan, s:darkgray ] ]
...
let s:p.insert.middle = [ [ s:green, s:darkgray ] ]
let s:p.visual.left = [ [ s:darkgray, s:yellow ], [ s:yellow, s:darkgray ] ]
let s:p.visual.middle = [ [ s:yellow, s:darkgray ] ]
let s:p.replace.left = [ [ s:darkgray, s:red ], [ s:red, s:darkgray ] ]
let s:p.replace.middle = [ [ s:red, s:darkgray ] ]
let s:p.inactive.left =  [ [ s:pink, s:darkgray ], [ s:white, s:darkgray ] ]
